...
coffee_fuzzy = addMF(coffee_fuzzy, 'Bean_Type', 'trapmf', [0 0 1 2], 'Name', 'Pahadi_Light');
coffee_fuzzy = addMF(coffee_fuzzy, 'Bean_Type', 'trapmf', [2 3 3 4], 'Name', 'Himalayan_Medium');
coffee_fuzzy = addMF(coffee_fuzzy, 'Bean_Type', 'trapmf', [4 5 5 6], 'Name', 'Everest_Bold');
coffee_fuzzy = addMF(coffee_fuzzy, 'Bean_Type', 'trapmf', [6 7 8 8], 'Name', 'Kanchanjunga_Dark');
figure;
...
coffee_fuzzy = addMF(coffee_fuzzy, 'Brewing_Duration', 'trapmf', [0 0 1 3], 'Name', 'Short');
coffee_fuzzy = addMF(coffee_fuzzy, 'Brewing_Duration', 'trapmf', [2 3 5 6], 'Name', 'Medium');
coffee_fuzzy = addMF(coffee_fuzzy, 'Brewing_Duration', 'trapmf', [5 6 8 9], 'Name', 'Long');
coffee_fuzzy = addMF(coffee_fuzzy, 'Brewing_Duration', 'trapmf', [8 9 10 10], 'Name', 'Very_Long');
figure;
...
coffee_fuzzy = addMF(coffee_fuzzy, 'Water_Temperature', 'trapmf', [70 75 85 90], 'Name', 'Medium');
coffee_fuzzy = addMF(coffee_fuzzy, 'Water_Temperature', 'trapmf', [90 95 110 110], 'Name', 'High');
figure;
